...
const Hero = () => {
  ...
  // Generate fixed positions for particles on component mount
  ...
  // Calculate opacity based on scroll position (fades out after 100px of scroll)
    ...
    >
      ...
      <div className="relative z-10 text-center text-white px-4 max-w-4xl mx-auto">
        <div>
          ...
          <div
            className="absolute bottom-0 left-1/2 transform -translate-x-1/2 translate-y-52 animate-bounce transition-opacity duration-300"
            style={{
